...
void UseP1Card(std::string& p1Input, int& p1Score, int& p2Score, std::string& p1LastCard,std::string& p2LastCard, std::vector<std::string>& p1Hand, std::string& p2LastCard2, std::string& p1LastCard2);

void UseP2Card(std::string& p2Input, int& p2Score, int& p1Score, std::string& p2LastCard,std::string& p1LastCard, std::vector<std::string>& p2Hand, std::string& p1LastCard2, std::string& p2LastCard2);
